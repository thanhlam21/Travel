          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Discover new cultures, breathtaking landscapes,
                  <br /> and unforgettable experiences. Join our adventures and
                  see the beauty our planet has to offer. Whether it's a serene
                  beach,
                  <br /> a bustling city, or a hidden gem, there's always
